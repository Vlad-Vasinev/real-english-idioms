...
Want to contribute? Use this GitHub repository, where you can suggest new idioms, phrasal verbs, or examples.
...
4.  In the description, include:
    ...
    - **Meaning:**
    - **Example sentence:**
    - **Where you heard it (optional):** e.g., "From *Transformers Prime*, season 2"
